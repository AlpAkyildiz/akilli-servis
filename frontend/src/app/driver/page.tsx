    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      <header className="bg-slate-800 border-b border-slate-700 px-4 py-4 flex justify-between items-center sticky top-0 z-10">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button onClick={() => { localStorage.clear(); router.push('/login'); }} className="text-sm bg-slate-700 hover:bg-red-500/20 text-slate-300 hover:text-red-400 border border-slate-600 hover:border-red-500/30 px-3 md:px-4 py-2 rounded-lg transition-colors font-medium">
            Çıkış
          </button>
        </div>
      </header>
